...
export default function Register() {
  ...
  function handleRegister() {
    // For now, just log values. Wiring to backend is next step.
    console.log({ name, email, role, bloodType });
    // TODO: validate and POST to /auth/register
  }
  ...
  return (
    <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
      ...
      <TextInput style={styles.input} value={email} onChangeText={setEmail} placeholder="juan@email.com" keyboardType="email-address" autoCapitalize="none" />
